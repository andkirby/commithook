...
class FullCommitMsg implements InterpreterInterface
{
    ...
    {
        $format = $this->_getConfig()->getNode('interpreters/FullCommitMsg/' . $this->_type . '/format');
        if (!$format) {
    ...
    {
        $regular = $this->_getConfig()->getNode('interpreters/FullCommitMsg/' . $this->_type . '/regular');
        if (!$regular) {
    ...
    {
        $keys = $this->_getConfig()->getNodeArray('interpreters/FullCommitMsg/' . $this->_type . '/key');
        if (!$keys) {
